...
function recargo(opción) {
  if (opción === 1) {
    alert(`${nombre}, tu costo de afiliación Obligatoria es de ${costo}. Debés permanecer afiliad@ al menos 24 meses y cumplir nuestros períodos de carencia`);
  } else if (opción === 2) {
    let recargoFinal = costo * 1.3
    alert(`${nombre}, tu costo de afiliación Voluntaria es de ${recargoFinal}. Podés darte de baja cuando lo desees y acceder al servicio completo desde el día 1!`);
  } else {
